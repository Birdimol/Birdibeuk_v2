...
les lois de la terre de Fangh ! <br>
            ...
            <br>
                <div class="cadre_image" style='width:200px;float:left;margin-right:20px;cursor:pointer;'>
                    <b style='font-size:20px;'>Aventurier</b><br>
                    <img  src='img/aventurier2.png' style='' />
                </div>
                
                <div class="cadre_image" style='width:200px;float:left;cursor:pointer;'>
                    <b style='font-size:20px;'>Soldat</b><br>
                    <img src='img/soldat.png' style='' />                    
                </div>
